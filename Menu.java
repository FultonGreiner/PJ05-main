        ...
        try {
            ...
            do {
                ...
                if (in.readStudent(username, password) != null) {
                    ...
                    StudentMenu studentMenu = new StudentMenu(student, in, out, edit);
                    ...
                    FileOutput out = new FileOutput();
                    TeacherMenu teacherMenu = new TeacherMenu(teacher, in, out, edit);
                    JOptionPane.showMessageDialog(null, "Login successful!", "Main menu", JOptionPane.PLAIN_MESSAGE);
                } else if (!edit.checkPassword(username, password, "TeacherData.txt") || !edit.checkPassword(username, password, "StudentData.txt")) {
